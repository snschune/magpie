...
validParams<MDGranularPropertyAux>()
{
  ...
  params.addClassDescription("Injects properties collected for MD particles from MDRunBase object user_object "
...
{
  return MooseEnum("granular_sum=2 granular_density=3 granular_interstitial_density=4");
}
